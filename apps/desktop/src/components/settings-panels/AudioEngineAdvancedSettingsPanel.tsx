...
export function AudioEngineAdvancedSettingsPanel() {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      setEnginePolicy(parseEnginePolicy(policyPayload));
          ...
          <>
            ...
            <div className="settings-number-grid">
              <label className="settings-number-item">
                <span>{t('settings.audioAdvanced.replayGain.preampDb')}</span>
                <input
      ...
      <div className="settings-audio-block">
        ...
        {canUse ? (
          <>
            ...
            <div className="settings-number-grid">
              <label className="settings-number-item">
                <span>{t('settings.audioAdvanced.crossfade.durationMs')}</span>
                <input
                  className="settings-number-input"
                  type="number"
                  min={0}
          ...
          <>
            <div className="settings-choice-row">
              ...
              <button
                ...
                onClick={() => setDynamicSrc((prev) => ({ ...prev, adaptiveEnabled: !prev.adaptiveEnabled }))}
                disabled={busy}
              >
                {t('settings.audioAdvanced.dynamicSrc.adaptive')}
              </button>
              <button
                type="button"
                className="settings-choice-btn"
                data-active={dynamicSrc.learningEnabled}
                onClick={() => setDynamicSrc((prev) => ({ ...prev, learningEnabled: !prev.learningEnabled }))}
                disabled={busy}
              >
                {t('settings.audioAdvanced.dynamicSrc.learning')}
              </button>
            </div>

            <div className="settings-number-grid">
              <label className="settings-number-item">
                <span>{t('settings.audioAdvanced.dynamicSrc.restoreDebounceMs')}</span>
                <input
                  className="settings-number-input"
                  type="number"
                  min={500}
              ...
              <label className="settings-number-item">
                <span>{t('settings.audioAdvanced.dynamicSrc.minSwitchIntervalMs')}</span>
                <input
                  className="settings-number-input"
                  type="number"
                  min={100}
              ...
              <label className="settings-number-item">
                <span>{t('settings.audioAdvanced.dynamicSrc.seekHoldMs')}</span>
                <input
                  className="settings-number-input"
                  type="number"
                  min={500}
              ...
              <label className="settings-number-item">
                <span>{t('settings.audioAdvanced.dynamicSrc.underrunHoldMs')}</span>
                <input
                  className="settings-number-input"
                  type="number"
                  min={2000}
              ...
              <label className="settings-number-item">
                <span>{t('settings.audioAdvanced.dynamicSrc.sharedStressHoldMs')}</span>
                <input
                  className="settings-number-input"
                  type="number"
                  min={1000}
              ...
              <label className="settings-number-item">
                <span>{t('settings.audioAdvanced.dynamicSrc.outputErrorHoldMs')}</span>
                <input
                  className="settings-number-input"
                  type="number"
                  min={1000}
