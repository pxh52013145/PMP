...
describe('attachPerformanceObservabilityBridge', () => {
  it('emits performance telemetry only on state changes', () => {
    ...
    const changedPressureSnapshot: PerformanceControlSnapshot = {
      ...
      webview2: {
        sampledAtMs: 10,
        webview2PrivateWorkingSetBytes: 95,
    ...
    processPerf.push({
      ...
      totalsSnapshot: {
        ...
        systemMemory: null,
        totals: {
          privateWorkingSetBytes: 75,
          workingSetBytes: 100,
          privateBytes: 80,
          cpuPercent: 15,
          appPrivateWorkingSetBytes: 8,
          appWorkingSetBytes: 10,
          appPrivateBytes: 9,
          appCpuPercent: 5,
          webview2PrivateWorkingSetBytes: 55,
          webview2WorkingSetBytes: 70,
          webview2PrivateBytes: 60,
          webview2CpuPercent: 12,
          otherPrivateWorkingSetBytes: 12,
