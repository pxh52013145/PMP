...
pub struct NativeAudioStatePayload {
    ...
    pub stability_action_profile: Option<String>,
    pub stability_profile: Option<String>,
    pub source_prepare_profile: Option<String>,
    pub stability_primary_reason: Option<String>,
    pub stability_reason_codes: Option<Vec<String>>,
    pub stability_hint_profile: Option<String>,
    pub stability_hint_primary_reason: Option<String>,
    pub stability_hint_reason_codes: Option<Vec<String>>,
    ...
    pub render_queue_page_lock_failure_count: Option<u64>,
    pub render_queue_page_lock_attempted_bytes: Option<u64>,
    pub render_queue_page_lock_succeeded_bytes: Option<u64>,
    pub render_queue_page_lock_failed_bytes: Option<u64>,
    ...
    pub realtime_memory_lock_attempted_bytes: Option<u64>,
    pub realtime_memory_lock_succeeded_bytes: Option<u64>,
    pub realtime_memory_lock_failed_bytes: Option<u64>,
    pub realtime_memory_lock_skipped_bytes: Option<u64>,
    pub realtime_memory_lock_failure_count: Option<u64>,
    pub realtime_memory_lock_skipped_count: Option<u64>,
    pub realtime_memory_locked_role_mask: Option<u64>,
    pub realtime_memory_failed_role_mask: Option<u64>,
    pub realtime_memory_skipped_role_mask: Option<u64>,
    pub realtime_memory_pressure_events: Option<u64>,
