...
pub const LIBRARY_COMMAND_NAMES: &[&str] = &[
    ...
    "music_library_bilibili_qr_generate",
    "music_library_bilibili_get_playback_cache_settings",
    "music_library_bilibili_set_playback_cache_settings",
    "music_library_bilibili_qr_poll",
    "music_library_bilibili_get_auth_status",
    "music_library_bilibili_logout",
    "music_library_bilibili_list_favorite_folders",
    "music_library_bilibili_list_favorite_resources",
    "music_library_bilibili_search_resource_by_bvid",
    "music_library_bilibili_prepare_cover_cache",
    "music_library_bilibili_list_playback_qualities",
    "music_library_bilibili_prepare_cached_playback",
    "music_library_bilibili_resolve_lyric_locator",
...
macro_rules! pmp_generate_handler {
    () => {
        tauri::generate_handler![
            ...
            crate::commands::library::music_library_bilibili_qr_generate,
            crate::commands::library::music_library_bilibili_get_playback_cache_settings,
            crate::commands::library::music_library_bilibili_set_playback_cache_settings,
            crate::commands::library::music_library_bilibili_qr_poll,
            crate::commands::library::music_library_bilibili_get_auth_status,
            crate::commands::library::music_library_bilibili_logout,
            crate::commands::library::music_library_bilibili_list_favorite_folders,
            crate::commands::library::music_library_bilibili_list_favorite_resources,
            crate::commands::library::music_library_bilibili_search_resource_by_bvid,
            crate::commands::library::music_library_bilibili_prepare_cover_cache,
            crate::commands::library::music_library_bilibili_list_playback_qualities,
            crate::commands::library::music_library_bilibili_prepare_cached_playback,
            crate::commands::library::music_library_bilibili_resolve_lyric_locator,
