...
mod windows_hit_test {
    ...
    use windows_sys::Win32::UI::WindowsAndMessaging::{
        ...
        SetWindowPos, GWLP_WNDPROC, GWL_EXSTYLE, HTTRANSPARENT, HWND_NOTOPMOST, MA_NOACTIVATE,
        SWP_FRAMECHANGED, SWP_NOACTIVATE, SWP_NOMOVE, SWP_NOSIZE, WM_MOUSEACTIVATE, WM_NCHITTEST,
...
pub fn ensure_ornaments_overlay_window(
    app: &AppHandle,
