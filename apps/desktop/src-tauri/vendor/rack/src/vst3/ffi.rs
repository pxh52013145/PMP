...
extern "C" {
    ...
    pub fn rack_vst3_plugin_open_editor_window(plugin: *mut RackVST3Plugin, title: *const c_char) -> c_int;
    pub fn rack_vst3_plugin_close_editor_window(plugin: *mut RackVST3Plugin) -> c_int;
    pub fn rack_vst3_plugin_editor_is_open(plugin: *mut RackVST3Plugin) -> c_int;
}
